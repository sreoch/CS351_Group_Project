...
//        Transaction t = new Transaction("scott", "jack", 100, TransactionType.TRANSFER);
//        ledger.addTransaction(t);
//
//        List<Transaction> all = ledger.getAllTransactions();
//        assertEquals(1, all.size());
//        assertEquals(t, all.getFirst());
//    }
//
//    @Test
//    public void testAddMultipleTransactions() {
//        Transaction t1 = new Transaction("scott", "jack", 100, TransactionType.TRANSFER);
//        Transaction t2 = new Transaction("jack", "fraser", 200, TransactionType.TRANSFER);
//        Transaction t3 = new Transaction(null, "scott", 300, TransactionType.DEPOSIT);
//
...
//        Transaction t2 = new Transaction("jack", "fraser", 200, TransactionType.TRANSFER);
//        Transaction t3 = new Transaction(null, "scott", 300, TransactionType.DEPOSIT);
//        Transaction t4 = new Transaction("fraser", "jack", 200,  TransactionType.TRANSFER);
//
//        ledger.addTransaction(t1);
//        ledger.addTransaction(t2);
//        ledger.addTransaction(t3);
